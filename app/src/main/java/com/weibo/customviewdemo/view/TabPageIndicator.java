...
//    = R.drawable.background_tab;//字体颜色的选择器
    ...
    public TabPageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabTextColor = a.getColor(R.styleable.TabPageIndicator_indicatorColor, tabTextColor);
        ...
        underlineColor = a.getColor(R.styleable.TabPageIndicator_indicatorColor, underlineColor);
